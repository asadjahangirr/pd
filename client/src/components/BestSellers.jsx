      ...
      <div className="mx-auto max-w-7xl px-5 lg:px-8">
        ...
        >
          ...
          <div key={active} className="flex flex-col justify-center gap-4 p-6 sm:p-8 md:p-12">
            ...
            <h3 className="font-display text-2xl font-semibold text-ink opacity-0 animate-[fade-up_0.5s_ease_0.04s_forwards] md:text-3xl">
              {p.name}
            </h3>
            <p className="max-w-md font-body text-sm leading-relaxed text-muted opacity-0 animate-[fade-up_0.5s_ease_0.08s_forwards]">
              {p.description}
            </p>
            <div className="flex items-baseline gap-3 opacity-0 animate-[fade-up_0.5s_ease_0.12s_forwards]">
            ...
            <div className="mt-3 flex flex-col gap-3 opacity-0 animate-[fade-up_0.5s_ease_0.16s_forwards] sm:flex-row sm:flex-wrap">
              <button
                disabled={soldOut}
                onClick={() => {
